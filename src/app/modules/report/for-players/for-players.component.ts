...
export class ForPlayersComponent implements OnInit {
  ...
  forPlayersByStores() {
    ...
    headers.push({ key: 'resource', val: 'players' })
  ...
  forPlayersByStoresGroupByPlayers(option: String) {
    let dateStartControlValue = this.form.controls.dateStart.value;
    let dateEndControlValue = this.form.controls.dateEnd.value;
    let headers = this.addHeaders(dateStartControlValue, dateEndControlValue);
    headers.push({ key: 'group_by', val: 'players' })
    headers.push({ key: 'resource', val: 'players' })
    let dateStart = new Date(dateStartControlValue);
    let dateEnd = new Date(dateEndControlValue);
  ...
  forPlayersByStoresGroupByStores(option: String) {
    let dateStartControlValue = this.form.controls.dateStart.value;
    let dateEndControlValue = this.form.controls.dateEnd.value;
    let headers = this.addHeaders(dateStartControlValue, dateEndControlValue);
  ...
  groupBy(option: any) {
    switch (option.key) {
      case 'stores-players':
        this.forPlayersByStores();
        break;
      case 'players':
        this.forPlayersByStoresGroupByPlayers(option.val);
        break;
      case 'stores':
        this.forPlayersByStoresGroupByStores(option.val);
        break;
      default:
