...
export const InOutReportTableConfig = {
  ...
  dataTable: {
    ...
    columns: [
      ...
      { header: 'ID de la tienda', align: 'left', key: 'playerStoreId', width: '100', show: true },
      { header: 'Usuario |  BO', align: 'left', key: 'userNames', width: '100', show: false },
      { header: 'Estado', align: 'left', key: 'status', width: '80', show: false },
      { header: 'FechaUTC', align: 'left', key: 'insDatetime', width: '100', show: false },
      { header: 'Fecha', align: 'left', key: 'insDatetimeTZ', width: '100', show: true },
    ],
    actionColumn: false,
    indexColumn: false,
